...
class GenresManager{
    ...
    func loadingGenresData(mediaType: String, completion: @escaping ([Genre]) -> Void) {
        ...
        AF.request("https://api.themoviedb.org/3/genre/\(mediaType)/list?language=en", headers: headers)
